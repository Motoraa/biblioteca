...
INNER JOIN imprumuturi ON biblioteca.Nr = imprumuturi.id_carte and imprumuturi.Status='1' and (DATEDIFF('$v1', imprumuturi.Data_imprumutului)>'90') and '$cnp'=imprumuturi.cnp ");
